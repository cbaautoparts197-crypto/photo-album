    ...
    <header class="front-header">
      <div class="container header-inner">
        ...
        <nav class="main-nav" :class="{ open: navOpen }">
          ...
          <a href="https://wa.me/" class="nav-link" v-if="company.whatsapp" target="_blank">WhatsApp</a>
        </nav>
      ...
      <div v-if="navOpen" class="mobile-nav">
        ...
        <a v-if="company.whatsapp" :href="'https://wa.me/' + company.whatsapp.replace(/[^0-9]/g, '')" class="mobile-nav-link" target="_blank">WhatsApp</a>
      </div>
    </header>
